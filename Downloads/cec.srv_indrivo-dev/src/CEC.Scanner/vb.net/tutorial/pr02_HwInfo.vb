    ...
    Class MainClass
        ...
        Public Function Program() As Integer
            ...
            For i As Integer = 0 To scannerinfo.GetWindowCount() - 1
                ...
                System.Console.WriteLine(vbTab & i & ": " & frame.Width / 1000.0F & " x " & frame.Height / 1000.0F & " mm")
            Next
            System.Console.WriteLine()
            ...
            For i As Integer = 0 To readers.Count - 1
                System.Console.WriteLine(vbTab & i & ": " & readers(i).Info.HwType.ToString())
                System.Console.WriteLine(vbTab & vbTab & "Firmware: " & readers(i).Info.GetVersion("F"c))
                System.Console.WriteLine(vbTab & vbTab & "Hardware: " & readers(i).Info.GetVersion("H"c))
                System.Console.WriteLine(vbTab & vbTab & "Software: " & readers(i).Info.GetVersion("S"c))
            Next
            System.Console.WriteLine()
            ...
            For i As Integer = 0 To leds.Count - 1
                System.Console.WriteLine(vbTab & i & ": color " & leds(i).Light.ToString())
            Next
            System.Console.WriteLine()
            ...
            Dim licenses As List(Of Pr22.Processing.EngineLicense) = EngineInfo.GetAvailableLicenses()
