...
echo     ^</Compile^>
if "%1"=="pr05_doctype" (
echo     ^<Compile Include="..\..\Pr22.Extension\CountryCode.vb"^>
echo       ^<Link^>CountryCode.vb^</Link^>
echo     ^</Compile^>
echo     ^<Compile Include="..\..\Pr22.Extension\DocumentType.vb"^>
echo       ^<Link^>DocumentType.vb^</Link^>
echo     ^</Compile^>
)
...
echo ^<assembly: AssemblyCopyright("Copyright � ARH 2018")^>
