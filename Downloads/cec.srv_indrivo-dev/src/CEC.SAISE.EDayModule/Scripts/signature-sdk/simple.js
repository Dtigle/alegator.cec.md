...
Module.onRuntimeInitialized = _ => {
	...
	const promise = mSigObj.setLicence("0d2867ab-f4cf-48f3-8080-81be36847bc5", "yZZUua0YbYuRK6w3uK92b3HWWoRhIpMRvgJJyd+hHzv2UMFetHexslmz60D+92cuWGGbpaXuF3IjzCeV+e1MjA==");
	promise.then(value => {
		if (value) {
			if (navigator.hid) {
