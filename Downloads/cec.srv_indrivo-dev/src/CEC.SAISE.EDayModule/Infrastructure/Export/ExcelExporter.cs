...
namespace CEC.SAISE.EDayModule.Infrastructure.Export
{
    public class ExcelExporter : GridExporter
    {
        ...
        private void CreateXlDocStructure()
        {
            ...
            _workbookPart.Workbook = new DocumentFormat.OpenXml.Spreadsheet.Workbook();
            var sheets = _workbookPart.Workbook.AppendChild(new DocumentFormat.OpenXml.Spreadsheet.Sheets());
            ...
            _writer.WriteStartElement(new DocumentFormat.OpenXml.Spreadsheet.Worksheet());
