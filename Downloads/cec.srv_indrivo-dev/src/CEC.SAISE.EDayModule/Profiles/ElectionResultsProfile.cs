...
namespace CEC.SAISE.EDayModule.Profiles
{
    public class ElectionResultsProfile : Profile
    {
        protected override void Configure()
        {
            ...
            Mapper.CreateMap<BallotPaperConsolidationDataModel, BallotPaperConsolidationDataExtendedDto>();
            Mapper.CreateMap<BallotPaperConsolidationDataExtendedDto, BallotPaperConsolidationDataModel>();
        }
    }
}