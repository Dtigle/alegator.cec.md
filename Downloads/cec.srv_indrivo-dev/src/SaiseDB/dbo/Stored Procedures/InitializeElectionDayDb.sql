...
/****** Object:  StoredProcedure [SAISE].[InitializeElectionDayDb]    Script Date: 1/17/2024 3:34:37 PM ******/
SET ANSI_NULLS ON
GO
...
BEGIN TRY
	...
	if(@is_test=0)begin
		...
		/* ElectionRound */
		SET @sql = @sql + '';
		SET @sql = 'INSERT INTO ' + @finalRemoteName + '.[ElectionRound] ([ElectionRoundId],[ElectionId],[Number],[NameRo],[NameRu],[Description],[ElectionDate],[CampaignStartDate],[CampaignEndDate],[Status], [EditUserId], [EditDate], [Version], [RepeatElection]) ';
		SET @sql = @sql + '(SELECT [electionRoundId],[electionId],[number],[nameRo],[nameRu],[description],[electionDate],[campaignStartDate],[campaignEndDate],[status], ' + @editUserId + ', GETDATE(), 1, [RepeatElection]';
