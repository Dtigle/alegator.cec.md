    ...
    public static class MenuHelper
    {
        ...
        private static List<MenuItem> CreateFullMenu()
        {
            ...
            return new List<MenuItem>
            {
                ...
                new MenuItem { Title = "Procese verbale", Css = "fa fa-archive", Controller = "ElectionResults", Action = "Index" },
                ...
                new MenuItem { Title = "Gestionarea funcițonală", Css = "fa fa-pencil-square-o", Controller = "PermissionManage", Action = "Index" },
