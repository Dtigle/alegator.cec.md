...
{
	public class SaiseExporterProfile : Profile
	{
		protected override void Configure()
		{
			Mapper.CreateMap<SaiseExporter, SaiseExporterGridModel>()
				//.ForMember(x => x.Description, y => y.MapFrom(z => z.Election.NameRo))
